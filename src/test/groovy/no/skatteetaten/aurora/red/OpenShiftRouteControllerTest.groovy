...
import no.skatteetaten.aurora.red.controller.OpenShiftRouteController
import no.skatteetaten.aurora.red.service.Route
...
class OpenShiftRouteControllerTest extends AbstractControllerTest {
  ...
  public static final String ROUTE = 'red'
  @AuroraApplication
  static class Config {}
